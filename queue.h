...
//typedef struct item (int grumtion; int charisma;)Item;
...
//precondition: pq points to qreviously initialized queue
...
//precondition: pq points to preveously initialized queue item is to be placed at rear of queue
//postcondition: if queue is not empty, item is placed at rear of queue and function returns
//               True; otherwise, queue is unchanged and function returns False
...
//               and function returns True; if the operation empties the queue, the queue is reset to empty.
//               if the queue is empty to begin with, queue is unchanged and the function returns False
bool DeQueue(Item *pitem, Queue *pq);

//operation: empty the queue
//precondition: pq points to previously initialized queue
//postcondtion: the queue is empty
